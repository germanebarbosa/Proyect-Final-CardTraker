	...
	return {
		...
		actions: {
			...
			login: (email,password) => {
				...
				fetch("https://germanebarbosa-symmetrical-meme-44g9rj7q7g7375pr-3001.preview.app.github.dev/api/login", requestOptions)
					.then(response => {
			...
			signup: (email,user_name,password) => {
				...
				fetch("https://germanebarbosa-symmetrical-meme-44g9rj7q7g7375pr-3001.preview.app.github.dev/api/signup", requestOptions)
